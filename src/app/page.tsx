...
export default function page() {
    return <form action={redirectToRoute1} className="prose dark:text-gray-200 text-gray-800">
        <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Redirect me to /route1</button>
        <ul>
            ...
            <ul>
                <li>
                    ...
                    <a
                        ...
                        href="https://github.com/technikhil314/nextjs-parallel-routes-sample/blob/chore/steaming-cookie-issue/server.ts#L19">
                        line 19 {" "}
